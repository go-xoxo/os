...
/* package squirrel-os-0.1.0.0 */
#ifndef VERSION_squirrel_os
#define VERSION_squirrel_os "0.1.0.0"
#endif /* VERSION_squirrel_os */
#ifndef MIN_VERSION_squirrel_os
#define MIN_VERSION_squirrel_os(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_squirrel_os */
...
#define CURRENT_COMPONENT_ID "squirrel-os-0.1.0.0-inplace-squirrel-os"
