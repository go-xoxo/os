...
-- at runtime using the environment variable squirrel_os_bindir.
...
-- environment variable squirrel_os_libdir.
...
-- using the environment variable squirrel_os_dynlibdir.
...
-- runtime using the environment variable squirrel_os_datadir.
...
-- variable squirrel_os_libexedir.
...
-- using the environment variable squirrel_os_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\squirrel-os-0.1.0.0-inplace-squirrel-os"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\squirrel-os-0.1.0.0"
libexecdir = "C:\\cabal\\squirrel-os-0.1.0.0-inplace-squirrel-os\\x86_64-windows-ghc-9.6.7\\squirrel-os-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "squirrel_os_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "squirrel_os_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "squirrel_os_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "squirrel_os_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "squirrel_os_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "squirrel_os_sysconfdir") (\_ -> return sysconfdir)
