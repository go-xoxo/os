...
-- at runtime using the environment variable tls_bindir.
...
-- environment variable tls_libdir.
...
-- using the environment variable tls_dynlibdir.
...
-- runtime using the environment variable tls_datadir.
...
-- using the environment variable tls_sysconfdir.
...
bindir     = "C:\\cabal\\store\\ghc-9.6.7\\tls-2.2.0-af1e6af734c205e2486553c5238efebc50265faf\\bin"
libdir     = "C:\\cabal\\store\\ghc-9.6.7\\tls-2.2.0-af1e6af734c205e2486553c5238efebc50265faf\\lib"
dynlibdir  = "C:\\cabal\\store\\ghc-9.6.7\\tls-2.2.0-af1e6af734c205e2486553c5238efebc50265faf\\lib"
datadir    = "C:\\cabal\\store\\ghc-9.6.7\\tls-2.2.0-af1e6af734c205e2486553c5238efebc50265faf\\share"
libexecdir = "C:\\cabal\\store\\ghc-9.6.7\\tls-2.2.0-af1e6af734c205e2486553c5238efebc50265faf\\libexec"
sysconfdir = "C:\\cabal\\store\\ghc-9.6.7\\tls-2.2.0-af1e6af734c205e2486553c5238efebc50265faf\\etc"

getBinDir     = catchIO (getEnv "tls_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "tls_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "tls_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "tls_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "tls_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "tls_sysconfdir") (\_ -> return sysconfdir)
